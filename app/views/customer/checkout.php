<div class="container py-5">
    ...
    <div class="alert alert-light border rounded-4 d-flex align-items-center gap-3 mb-4" role="note">
        <i class="fas fa-lock-open text-success fs-4" aria-hidden="true"></i>
        <div>
            <strong class="text-dark">Guest Checkout</strong>
            <span class="text-muted">— no account needed to place your order.</span>
            <?php if (!empty($_SESSION['user_id'])): ?>
                <span class="text-muted d-block small mt-1">You're ordering as a member — we'll use your saved details where possible.</span>
            <?php else: ?>
                <a href="/login" class="small fw-bold ms-2">Have an account? Login</a>
            <?php endif; ?>
        </div>
    </div>
