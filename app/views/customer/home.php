...
<section id="hero" aria-label="Hero — Adil's Signature Kitchen" style="background:linear-gradient(135deg,rgba(106,27,46,.05) 0%,rgba(212,163,115,.1) 100%);padding:60px 0 80px;">
    <!-- Ambient background animation (motion tokens; gated by prefers-reduced-motion) -->
    ...
    <div class="container">
        <div class="row align-items-center g-5" style="min-height:80vh;">
            ...
            <div class="col-lg-6" data-aos="fade-right">
                ...
                <div class="d-flex flex-wrap gap-4 pt-3 border-top" itemscope itemtype="https://schema.org/AggregateRating">
                    <div class="text-center">
                        <div class="fw-bold fs-4" style="color:var(--primary);" data-count="5000" data-suffix="+">0+</div>
                        <small class="text-muted">Happy Customers</small>
                    </div>
                    <div class="text-center">
                        <div class="fw-bold fs-4" style="color:var(--primary);" itemprop="ratingValue" data-count="4.9" data-decimals="1" data-suffix="/5">0/5</div>
                        <small class="text-muted" itemprop="reviewCount">2,000+ Reviews</small>
                    </div>
                    <div class="text-center">
                        <div class="fw-bold fs-4" style="color:var(--primary);" data-count="100" data-suffix="%">0%</div>
            ...
            <div class="col-lg-6 text-center" data-aos="fade-left">
                <div class="hero-float" style="position:relative;display:inline-block;">
                    ...
                    <!-- Floating badges -->
                    <div class="hero-fbadge" style="position:absolute;top:20px;left:-10px;background:#fff;border-radius:12px;padding:10px 14px;box-shadow:0 8px 30px rgba(0,0,0,.12);display:flex;align-items:center;gap:8px;">
                    ...
                    <div class="hero-fbadge" style="position:absolute;bottom:20px;right:-10px;background:#fff;border-radius:12px;padding:10px 14px;box-shadow:0 8px 30px rgba(0,0,0,.12);display:flex;align-items:center;gap:8px;">
...
<div class="mq-wrap" aria-hidden="true">
    <div class="mqtrack d-flex gap-5 fw-semibold text-uppercase" style="font-size:.75rem;letter-spacing:2px;">
        <?php
        ...
        for ($i=0;$i<3;$i++) foreach($items as $it) echo '<span style="color:var(--secondary);margin-right:40px;">'.$it.'</span>';
        ?>
    </div>
</div>
            ...
            <?php foreach ($categories as $cat): ?>
                <div class="col-6 col-md-4 col-lg-3" data-aos="zoom-in">
                    <a href="/shop?category=<?= htmlspecialchars($cat['slug'] ?? '') ?>"
                       class="cat-item d-block text-center p-3 rounded-4 bg-white text-decoration-none h-100"
                    ...
                    <article class="card border-0 rounded-4 overflow-hidden h-100 product-card">
                        ...
                        <div class="card-body p-4 d-flex flex-column">
                            ...
                            <div class="mt-auto d-flex flex-column gap-2">
                                ...
                                <button class="btn w-100 rounded-pill btn-buy-now"
                                        data-product-id="<?= (int)$p['id'] ?>"
                                        aria-label="Buy <?= htmlspecialchars($p['name']) ?> now">
...
<!-- ═══════════════════════════════════════════════════════════
     ...
     ═══════════════════════════════════════════════════════════ -->
<section class="py-5 text-white cta-banner" aria-labelledby="custom-cake-heading"
