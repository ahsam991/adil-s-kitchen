...
<head>
    ...
    <style>
        ...
        .btn-primary-custom { background: linear-gradient(135deg,#6A1B2E,#521323); color:#fff; border:none; border-radius:50px; padding:10px 22px; font-weight:600; }
        .btn-primary-custom:hover { color:#fff; opacity:.92; }
        .btn-outline-custom { background:transparent; color:var(--primary); border:2px solid var(--primary); border-radius:50px; padding:8px 18px; font-weight:600; }
