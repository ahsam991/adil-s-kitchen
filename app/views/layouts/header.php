...
<head>
    ...
    <!-- ═══════════════════════════════════════════════
         BRAND THEME — design tokens & component styles
         live in /assets/css/style.css (single source of truth)
         ═══════════════════════════════════════════════ -->
    ...
    <div class="container">
        <div class="d-flex justify-content-between align-items-center flex-wrap gap-2">
            <div class="top-contact d-flex flex-wrap gap-3" itemscope itemtype="https://schema.org/LocalBusiness">
                ...
                <span itemprop="address" itemscope itemtype="https://schema.org/PostalAddress" class="d-none d-lg-inline">
                    <i class="fas fa-map-marker-alt" aria-hidden="true"></i>
                    <span itemprop="addressLocality">Dhaka</span>, <span itemprop="addressCountry">Bangladesh</span>
                </span>
            </div>
            <div class="d-flex align-items-center gap-3">
                <span class="ttag d-none d-sm-inline-block"><i class="fas fa-heart me-1" aria-hidden="true"></i>"Homemade With Love"</span>
                <div class="tsoc d-none d-sm-flex" aria-label="Social media links">
...
<!-- ═══════════════════════════════════════════════════════════
     NAVBAR
     ═══════════════════════════════════════════════════════════ -->
<nav class="navbar navbar-expand-xl" id="nav" role="navigation" aria-label="Main navigation">
    <div class="container">
        <a class="navbar-brand" href="/" aria-label="Adil's Signature Kitchen - Homepage">
            <div class="blogo">
                <div class="bico"><i class="fas fa-birthday-cake" aria-hidden="true"></i></div>
                <div>
        ...
        <!-- Always-visible actions: wishlist, cart, account, CTA, toggler -->
        <div class="nav-actions d-flex align-items-center gap-2 ms-auto order-lg-3">
            <a href="/wishlist" class="nav-icon-btn d-none d-sm-inline-flex" aria-label="Wishlist" title="Wishlist">
                <i class="far fa-heart" aria-hidden="true"></i>
            </a>
            <a href="/cart" class="nav-icon-btn position-relative" aria-label="Shopping Cart" title="Cart" id="cart-btn">
                <i class="fas fa-shopping-bag" aria-hidden="true"></i>
                <span class="cart-count" id="cart-badge" style="display:none;"></span>
            </a>
            <?php if (isset($_SESSION['user_id'])): ?>
                <?php if (isset($_SESSION['user_role']) && in_array($_SESSION['user_role'], ['admin', 'super_admin'])): ?>
                    <a href="/admin/dashboard" class="nav-icon-btn" aria-label="Admin Dashboard" title="Admin Panel">
                        <i class="fas fa-shield-alt" aria-hidden="true"></i>
                    </a>
                <?php else: ?>
                    <a href="/my-account" class="nav-icon-btn" aria-label="My Account" title="My Account">
                        <i class="fas fa-user" aria-hidden="true"></i>
                    </a>
                <?php endif; ?>
            <?php else: ?>
                <a href="/login" class="nav-icon-btn" aria-label="Login" title="Login">
                    <i class="fas fa-sign-in-alt" aria-hidden="true"></i>
                </a>
            <?php endif; ?>
            <a href="https://wa.me/8801303721109" target="_blank" rel="noopener" class="btn-cta d-none d-xxl-inline-flex" aria-label="Order Now on WhatsApp">
                <i class="fab fa-whatsapp me-2" aria-hidden="true"></i>Order Now
            </a>
        ...
        <div class="collapse navbar-collapse order-lg-1" id="navmenu">
            <ul class="navbar-nav mx-auto" role="list">
                ...
                <li class="nav-item" role="listitem">
                    <a class="nav-link" href="/custom-cake" aria-label="Design your custom cake">
